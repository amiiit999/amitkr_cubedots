...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><strong>{{ __('UPDATE POST') }}</strong></div>
                ...
                <div class="card-body">
                    ...
                    @endif
                             ...
                             <form class="form-horizontal" method="POST" action='{{ url("/editpost/$posts->id") }}' enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('post_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="post_title" type="post_title" class="form-control" name="post_title" value="{{ $posts->post_title }}" >
                        ...
                        <div class="form-group{{ $errors->has('text_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <textarea id="text_body" rows="5" class="form-control" name="text_body">{{ $posts->description }}</textarea>
